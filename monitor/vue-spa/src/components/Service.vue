  ...
  <section class="section">
    ...
    <div class="columns">
      <div class="column">
        ...
        <MonitorTable :monitors="service.monitors" :columns="['monitorId', 'updatedAt']"></MonitorTable>
      </div>
      <div class="column">
        <div class="tabs">
          <ul>
    ...
    <CheckTable :healthChecks="service.healthChecks" :columns="['id', 'monitorId', 'source', 'version', 'performance', 'updatedAt']"></CheckTable>
